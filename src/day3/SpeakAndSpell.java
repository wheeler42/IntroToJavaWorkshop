...
String answer = JOptionPane.showInputDialog("spell the word just mentioned above");
		// 3. If the user spelled the word correctly, speak "correct"
if(answer.equalsIgnoreCase("mississippi")) {
	speak("that is correct. we will now take over the world");
}
		// 4. Otherwise say "wrong"
else {
	speak("you are wrong. now you have to die");
}
